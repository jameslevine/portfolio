...
import TicketmasterPortfolioDetails from "./elements/PortfolioDetails";
        ...
        return(
            <BrowserRouter basename={'/'}>
                <Switch>
                    ...
                    <Route exact path={`${process.env.PUBLIC_URL}/portfolio-details/:client`} component={TicketmasterPortfolioDetails}/>
